...
public class InetRange implements Cloneable{
    ...
    public synchronized boolean remove(String s){
      Enumeration enum0 = all.elements();
      while(enum0.hasMoreElements()){
        Object[] entry = (Object[]) enum0.nextElement();
        if(s.equals(entry[0])){
...
/////////////////
    ...
    private synchronized boolean contains(long ip){
       Enumeration enum0 = all.elements();
       while(enum0.hasMoreElements()){
         Object[] obj = (Object[]) enum0.nextElement();
    ...
    private boolean checkHostEnding(String host){
       Enumeration enum0 = end_names.elements();
       while(enum0.hasMoreElements()){
          if(host.endsWith((String) enum0.nextElement())) return true;
       }
       return false;
    }
